...
name: clone-website
description: >-
  Reverse-engineers and clones any website — from a single static HTML file to a
  WebGL-heavy interactive app — by recovering real source where possible, then either
  mirroring it byte-for-byte or rebuilding it as clean Next.js/React, with objective
  pixel-diff verification. Use when the user wants to "clone this site", "replicate",
  "rebuild this page", "reverse-engineer", "copy", "mirror", "make a copy of", or get a
  "pixel-perfect clone" of a website or a specific interaction / WebGL / Canvas effect.
